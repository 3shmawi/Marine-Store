...
class EditUploadedProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    discountController.text = productModel.discountValue.toString();
                        ...
                        child: Container(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10)),
                              child: Image.memory(
                                base64Decode(productModel.imgUrl),
                                width: double.infinity,
                                fit: BoxFit.cover,
                              ),
                            )),
                    ...
                    Container(
                      ...
                      child: BlocBuilder<AdminUploadProductViewCubit,
                        ...
                        builder: (context, state) {
                          context
                              .read<AdminUploadProductViewCubit>()
                              .changeSelectedCategory(productModel.category);
                          return Padding(
                ...
                Padding(
                  ...
                  child: BlocConsumer<AdminUploadProductViewCubit,
                    ...
                    listener: (context, state) {
                      if (state is AdminViewEditPostProductSuccessState) {
                        Navigator.pop(context);
                        showToast(
                            text: 'Product Edited successfully',
                            color: Colors.green);
                      } else if (state is AdminViewEditPostProductErrorState) {
                        showToast(
                          text:
                    ...
                    builder: (context, state) {
                      return state is AdminViewEditPostProductLoadingState
                          ? const Center(
  ...
  void submitConditions(GlobalKey<FormState> formKey, BuildContext context) {
    ...
    if (formKey.currentState!.validate()) {
      if (context.read<AdminUploadProductViewCubit>().base64String == null) {
        ...
        context.read<AdminUploadProductViewCubit>().editProduct(
              ...
              category:
                  context.read<AdminUploadProductViewCubit>().selectedCategory,
